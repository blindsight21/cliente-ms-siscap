 ...
 * @author Omar
 */
public class ModalidadActividadBean implements Serializable {
    ...
    public String toString() {
        return "ModalidadActividadBean{" + "nidModalidadActividad=" + nidModalidadActividad + ", txtModalidadActividad=" + txtModalidadActividad + ", flgActivo=" + flgActivo + ", nidUsuario=" + nidUsuario + ", txtPc=" + txtPc + ", txtIp=" + txtIp + ", fecEdicion=" + fecEdicion + '}';
    }
