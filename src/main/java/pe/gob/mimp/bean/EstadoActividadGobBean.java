 ...
 * @author Omar
 */
public class EstadoActividadGobBean implements Serializable {
    ...
    public String toString() {
        return "EstadoActividadGobBean{" + "nidEstadoActividadGob=" + nidEstadoActividadGob + ", txtEstadoActividadGob=" + txtEstadoActividadGob + ", flgActivo=" + flgActivo + ", nidUsuario=" + nidUsuario + ", txtPc=" + txtPc + ", txtIp=" + txtIp + ", fecEdicion=" + fecEdicion + '}';
    }
