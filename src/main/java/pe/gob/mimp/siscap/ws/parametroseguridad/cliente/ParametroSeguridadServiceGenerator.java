 ...
 * @author Omar
 */
public class ParametroSeguridadServiceGenerator {

    private static final String BASE_PARAMETRO_SEGURIDAD_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_SEGURIDAD);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_PARAMETRO_SEGURIDAD_URL)
