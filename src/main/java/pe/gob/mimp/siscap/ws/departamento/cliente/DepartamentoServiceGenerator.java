 ...
 * @author Omar
 */
public class DepartamentoServiceGenerator {

    private static final String BASE_DEPARTAMENTO_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_GENERAL);
