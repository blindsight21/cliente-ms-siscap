 ...
 * @author Omar
 */
public class DistritoCoordenadasServiceGenerator {

    private static final String BASE_DISTRITO_COORDENADAS_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_GENERAL);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_DISTRITO_COORDENADAS_URL)
