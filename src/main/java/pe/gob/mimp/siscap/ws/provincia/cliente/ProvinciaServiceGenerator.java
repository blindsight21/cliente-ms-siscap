 ...
 * @author Omar
 */
public class ProvinciaServiceGenerator {

    private static final String BASE_PROVINCIA_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_GENERAL);
