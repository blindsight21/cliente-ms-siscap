 ...
 * @author Omar
 */
public class PerfilServiceGenerator {

    private static final String BASE_PERFIL_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_SEGURIDAD);
