 ...
 * @author Omar
 */
public class TipoPersonaServiceGenerator {

    private static final String BASE_TIPO_PERSONA_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_SEGURIDAD);
