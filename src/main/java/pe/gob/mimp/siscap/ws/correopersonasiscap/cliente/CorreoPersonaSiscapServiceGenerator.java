 ...
 * @author Omar
 */
public class CorreoPersonaSiscapServiceGenerator {

    private static final String BASE_CORREO_PERSONA_SISCAP_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_ACTIVIDAD_GOBIERNO);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_CORREO_PERSONA_SISCAP_URL)
