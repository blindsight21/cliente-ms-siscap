 ...
 * @author Omar
 */
public class TipoDocumentoServiceGenerator {

    private static final String BASE_TIPO_DOCUMENTO_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_SEGURIDAD);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_TIPO_DOCUMENTO_URL)
