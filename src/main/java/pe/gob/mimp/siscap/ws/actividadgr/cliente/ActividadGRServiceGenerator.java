 ...
 * @author Omar
 */
public class ActividadGRServiceGenerator {

    private static final String BASE_ACTIVIDAD_GR_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_ACTIVIDAD_GOBIERNO);
