 ...
 * @author Omar
 */
public class VwActividadServiceGenerator {

    private static final String BASE_VW_ACTIVIDAD_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_CONSULTA_VISTAS);
