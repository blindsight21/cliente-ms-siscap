 ...
 * @author Omar
 */
public class TipoEvaluacionServiceGenerator {

    private static final String BASE_TIPO_EVALUACION_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_TIPO_EVALUACION);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_TIPO_EVALUACION_URL)
