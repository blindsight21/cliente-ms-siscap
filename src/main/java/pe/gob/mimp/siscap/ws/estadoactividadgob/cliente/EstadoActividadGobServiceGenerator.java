 ...
 * @author Omar
 */
public class EstadoActividadGobServiceGenerator {

    private static final String BASE_ESTADO_ACTIVIDAD_GOB_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_ESTADO_ACTIVIDAD_GOB);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_ESTADO_ACTIVIDAD_GOB_URL)
