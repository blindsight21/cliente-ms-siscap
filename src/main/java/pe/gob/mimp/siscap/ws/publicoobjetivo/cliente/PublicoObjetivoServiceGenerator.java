 ...
 * @author Omar
 */
public class PublicoObjetivoServiceGenerator {

    private static final String BASE_TIPOOBJETIVO_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_PUBLICO_OBJETIVO);
