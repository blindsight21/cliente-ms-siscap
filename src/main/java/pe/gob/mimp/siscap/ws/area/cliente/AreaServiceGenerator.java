 ...
 * @author Omar
 */
public class AreaServiceGenerator {

    private static final String BASE_AREA_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_SEGURIDAD);
