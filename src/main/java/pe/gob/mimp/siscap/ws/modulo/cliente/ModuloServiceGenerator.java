 ...
 * @author Omar
 */
public class ModuloServiceGenerator {

    private static final String BASE_MODULO_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_SEGURIDAD);
