 ...
 * @author Omar
 */
public class TipoObjetivoServiceGenerator {

    private static final String BASE_TIPO_OBJETIVO_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_TIPO_OBJETIVO);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_TIPO_OBJETIVO_URL)
