 ...
 * @author Omar
 */
public class ActividadGEServiceGenerator {

    private static final String BASE_ACTIVIDAD_GE_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_ACTIVIDAD_GOBIERNO);
