 ...
 * @author Omar
 */
public class NivelEvaluacionServiceGenerator {

    private static final String BASE_NIVEL_EVALUACION_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_ACTIVIDAD_GOBIERNO);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_NIVEL_EVALUACION_URL)
