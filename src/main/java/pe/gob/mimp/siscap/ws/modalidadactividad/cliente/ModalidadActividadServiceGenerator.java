 ...
 * @author Omar
 */
public class ModalidadActividadServiceGenerator {

    private static final String BASE_MODALIDAD_ACTIVIDAD_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_MODALIDAD_ACTIVIDAD);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_MODALIDAD_ACTIVIDAD_URL)
