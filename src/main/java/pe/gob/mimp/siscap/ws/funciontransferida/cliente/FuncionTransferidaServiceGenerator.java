 ...
 * @author Omar
 */
public class FuncionTransferidaServiceGenerator {

    private static final String BASE_FUNCION_TRANSFERIDA_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_FUNCION_TRANSFERIDA);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_FUNCION_TRANSFERIDA_URL)
