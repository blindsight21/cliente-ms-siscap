 ...
 * @author Omar
 */
public class ProgramacionFechaServiceGenerator {

    private static final String BASE_PROGRAMACION_FECHA_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_PROGRAMACION_FECHA);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_PROGRAMACION_FECHA_URL)
