 ...
 * @author Omar
 */
public class DisponibilidadServiceGenerator {

    private static final String BASE_ACTIVIDAD_GOB_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_ACTIVIDAD_GOBIERNO);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_ACTIVIDAD_GOB_URL)
