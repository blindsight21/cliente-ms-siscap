 ...
 * @author Omar
 */
public class VwCantidadActividadServiceGenerator {

    private static final String BASE_VW_CANTIDAD_ACTIVIDAD_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_CONSULTA_VISTAS);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_VW_CANTIDAD_ACTIVIDAD_URL)
