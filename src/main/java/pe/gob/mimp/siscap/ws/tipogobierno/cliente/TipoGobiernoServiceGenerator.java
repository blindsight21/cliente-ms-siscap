 ...
 * @author Omar
 */
public class TipoGobiernoServiceGenerator {

    private static final String BASE_TIPO_GOBIERNO_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_TIPO_GOBIERNO);
...
//    private static final ObjectMapper OBJECT_MAPPER = new ObjectMapper();
    ...
    private static final Retrofit.Builder builder
            = new Retrofit.Builder()
                    .baseUrl(BASE_TIPO_GOBIERNO_URL)
