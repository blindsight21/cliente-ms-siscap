 ...
 * @author Omar
 */
public class DistritoServiceGenerator {

    private static final String BASE_DISTRITO_URL = Util.construirURI(Constantes.IP_SERVIDOR, Constantes.PuertoMicroservicios.MS_GENERAL);
